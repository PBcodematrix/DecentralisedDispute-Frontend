...
const contractAddress="0xd270Fff6cf8e161a1417192603Ae2766C4E38936";
...
const DisputeCard = ({
  ...
  const renderActionButton = () => {
    ...
    if (isOwner) {
      if (!VotersAssigned) {
        return (
          <Button size="small" disabled={loading} variant="contained"  onClick={handleAssignVoters}>
  ...
  return (
    // <Tooltip  title="Cards are shown" placement='left' arrow TransitionComponent={Zoom}>
